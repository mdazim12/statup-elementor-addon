 ...
 * @since 1.0.0
 */
class Statup_Heading_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Statup Heading ', 'statup-extension' );
	}
	...
	public function get_keywords() {
		return [ 'statup_heading', 'url', 'link' ];
	}
